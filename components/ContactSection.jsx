        ...
        <form className="w-full mt-8">
          <div className="w-full flex gap-2 flex-col md:flex-row">
            <div className="w-full  md:w-1/2 flex items-center border-b border-gray-400">
              ...
              <input type="text" className='w-full p-1 focus:outline-none border-none bg-transparent text-[#73F8AB]' placeholder='Your name' />
            </div>
            <div className="w-full md:w-1/2 flex border-b border-gray-400 items-center md:mt-0 mt-4">
              <div className="bg-gray-400 p-1">
                <MdAlternateEmail className='text-2xl' />
              </div>
              <input type="text" className='w-full p-1 focus:outline-none border-none bg-transparent  text-[#73F8AB]' placeholder='Email' />
            </div>
          </div>
          <div className="w-full mt-4">
            <textarea name="" placeholder='Message' id="" className='w-full h-48 p-1 focus:outline-none  bg-transparent border-b shadow border-gray-400  text-[#73F8AB]' cols="30" rows="10"></textarea>
          </div>
