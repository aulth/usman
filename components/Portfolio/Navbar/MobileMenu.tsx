        ...
        <nav>
            ...
            <ul ref={menu} className='flex md:flex-row flex-col md:static absolute md:w-auto w-full md:max-h-[500px] max-h-0 md:shadow-none shadow-lg overflow-hidden md:bg-transparent bg-white/20 backdrop-blur-sm transition-all duration-150 md:mt-0 mt-2  gap-4 left-0'>
                <li className='md:p-0 pt-4'>
                    <Button className='md:!rounded-button md:shadow shadow-none md:w-auto w-full md:border md:border-primary border-none bg-transparent text-sm font-medium font-poppins text-left inline-block'>About me</Button>
                </li>
                <li className='md:p-0 pb-4'>
                    <Button className='md:!rounded-button md:shadow shadow-none md:w-auto w-full md:text-black text-primary md:bg-white bg-transparent md:border border-none font-poppins font-medium text-left  text-sm  inline-block  hover:md:bg-secondary '>Contact</Button>
                </li>
            </ul>
        </nav>
    )
