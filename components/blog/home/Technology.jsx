...
const Technology = ({ data }) => {
    ...
    useEffect(() => {
        setTips(data.filter(item => item.category == 'technology'));
    }, [])
    ...
    return (
        <div className="w-full rounded-lg p-4">
            <div className="w-full flex justify-between">
                ...
                <Link href={'/blog/category/technology'} className="flex items-center text-cyan-500">View all <IoIosArrowRoundForward className='mt-1' /></Link>
            </div>
